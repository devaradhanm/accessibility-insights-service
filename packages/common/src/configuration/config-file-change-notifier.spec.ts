...
import { ConfigFileChangeNotifier } from './config-file-change-notifier';
...
describe(ConfigFileChangeNotifier, () => {
    ...
    beforeEach(() => {
        ...
        storageBlob.credentialsProviderMock.setup(async c => c.getCredentialsForStorage()).returns(async () => credentialsStub);
